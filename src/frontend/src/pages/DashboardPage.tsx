...
import { ArrowLeft, Wallet, Package, AlertCircle, Loader2, Send, ShieldAlert, LogIn } from 'lucide-react';
import { toast } from 'sonner';
import AppHeader from '@/components/AppHeader';
import { useGetBalance, useDistributeFunds } from '@/hooks/useQueries';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                {balanceLoading ? (
                  ...
                  <div className="text-2xl font-bold">{formatBalance(userBalance || BigInt(0))}</div>
                )}
                  ...
                  {adminWalletStatus.status === 'success' && (
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium">Admin Wallet Balance:</span>
            ...
            <Card className={!isAdminSuccess ? 'opacity-60' : ''}>
              ...
              <CardContent>
                {!isAdminSuccess && adminWalletStatus.status === 'unauthorized' && (
                  <Alert className="mb-4">
                    <ShieldAlert className="h-4 w-4" />
                    <AlertTitle>Admin Access Required</AlertTitle>
                    <AlertDescription>
                      This feature is only available to administrators. Contact a system administrator to request admin permissions.
                    </AlertDescription>
                  </Alert>
                )}
